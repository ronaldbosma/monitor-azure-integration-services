...
resource logicApp 'Microsoft.Web/sites@2025-03-01' = {
  ...
  properties: {
    ...
    siteConfig: {
      ...
      // Path to the health check endpoint for the Logic App must not exceed 64 characters.
...
module assignRolesToLogicAppSystemAssignedIdentity '../../99-shared/assign-roles-to-principal.bicep' = {
  params: {
